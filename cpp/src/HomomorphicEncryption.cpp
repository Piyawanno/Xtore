...
CiphertextDCRTPoly HomomorphicEncryption::encrypt(const std::vector<double> &plain) {
...
PlaintextDCRTPoly HomomorphicEncryption::decrypt(CiphertextDCRTPoly ciphertext) {
	PlaintextDCRTPoly plaintext;
