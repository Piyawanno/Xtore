...
from openfhe import (CCParamsCKKSRNS, GenCryptoContext, SchSwchParams, 
FIXEDAUTO, HEStd_NotSet, UNIFORM_TERNARY, HYBRID, PKE, KEYSWITCH, LEVELEDSHE, 
ADVANCEDSHE, SCHEMESWITCH, TOY)
...
cdef class Homomorphic():
    ...
    cdef object getSign(self, object cDiff):
        ...
        cdef object LWESign = self.ccLWE.EvalSign(LWECiphertexts[0])
        return self.ccLWE.Decrypt(self.privateKeyFHEW, LWESign, 2)
